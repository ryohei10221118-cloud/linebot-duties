...
1. 找到 `resettlement_detector.html` 文件
2. 用瀏覽器打開（雙擊文件，或右鍵選擇「用瀏覽器打開」）
3. 開始使用！

### 方法 2：載入範例數據

1. 打開網頁後，點擊「📝 範例 1 (交易記錄)」或「📝 範例 2 (注單詳情)」
2. 點擊「🔍 開始檢測」按鈕
3. 查看檢測結果
